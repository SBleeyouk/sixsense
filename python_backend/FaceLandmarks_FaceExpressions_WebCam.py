...
from sixsense.python_backend.FaceLandmarks.lib.config.defaults import _C as cfg
from sixsense.python_backend.FaceLandmarks.lib.models.hrnet import get_face_alignment_net
from scipy.spatial import procrustes
from sixsense.python_backend.FaceExpressions.Vit_ResNet_Modified import ViT
import os
import socketio
...
class RealFaceVideo:
    def __init__(self, video_path, socketio, stop_event):
        ...
        # HRNet model setup
        self.cfg = cfg
        self.config_file = '/Users/jy954/PycharmProjects/Contest/sixsense/python_backend/FaceLandmarks/experiments/wflw/face_alignment_wflw_hrnet_w18.yaml'
        self.cfg.defrost()
        self.cfg.merge_from_file(self.config_file)
        self.cfg.freeze()
        self.model = get_face_alignment_net(self.cfg)
        self.hrnet_checkpoint = '/Users/jy954/PycharmProjects/Contest/sixsense/python_backend/FaceLandmarks/hrnetv2_trained/HR18-WFLW.pth'
